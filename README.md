...
* A working OpenSSL implementation on your OS.  OpenSSL comes pre-built with most Linux distributions and other forms of Unix such as *BSD.  There may or may not be a working OpenSSL implementation on a Windows system. 

## Contributors

This is just a fork of a fork with very minor alterations for laravel version compatibility. Please see the fork history or the code to see the orig authors.
...
"repositories": [
        {
            "type": "vcs",
            "url": "https://github.com/ITwrx/elocryptfive.git"
        }
    ]
```
